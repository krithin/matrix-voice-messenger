...
version = exec_file(("matrix_voice_messenger", "__init__.py"))["__version__"]
long_description = read_file(("README.md",))


setup(
    name="matrix-voice-messenger",
    version=version,
    ...
    # Allow the user to run the bot with `matrix-voice-messenger ...`
    scripts=["matrix-voice-messenger"],
)
