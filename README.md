...
The majority of the code is kept inside of the `matrix_voice_messenger` folder, which
...
To run the bot, the `matrix-voice-messenger` script in the root of the codebase is
...
the `matrix_voice_messenger` directory:
